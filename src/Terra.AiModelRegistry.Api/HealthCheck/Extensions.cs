...
namespace Terra.AiModelRegistry.Api.HealthCheck
{
	public static class Extensions
	{
			...
			this IEndpointRouteBuilder endpoint, HealthCheckConfig.EndpointConfig config)
		{
			...
			if (config.VerboseResponse) theOptions.ResponseWriter = Terra.AiModelRegistry.Api.HealthCheck.ResponseWriter.WriteResponse;
