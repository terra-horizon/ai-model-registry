...
namespace Terra.AiModelRegistry.App.Service.AAI
{
	public class AAIKeycloakService : IAAIService
	{
		...
		private async Task<Model.Group> FindUserPrincipalGroup(String subjectlId)
		{
			...
			catch (System.Exception ex)
			{
				...
				throw new TerraUnderpinningException(this._errors.UnderpinningService.Code, this._errors.UnderpinningService.Message, null, UnderpinningServiceType.AAI, this._logCorrelationScope.CorrelationId);
			}
			...
			else if (groups.Count > 1) throw new TerraUnderpinningException(this._errors.UnderpinningService.Code, this._errors.UnderpinningService.Message, null, UnderpinningServiceType.AAI, this._logCorrelationScope.CorrelationId);
		...
		private async Task<String> EnsureHierarchyLevel(String parentId, String name, Dictionary<string, List<string>> attributes)
		{
			...
			else if (groups != null && groups.Count(x => x.Name == name) > 1) throw new TerraUnderpinningException(this._errors.UnderpinningService.Code, this._errors.UnderpinningService.Message, null, UnderpinningServiceType.AAI, this._logCorrelationScope.CorrelationId);
			else
			{
				...
				if (locationParts.Length == 0) throw new TerraUnderpinningException(this._errors.UnderpinningService.Code, this._errors.UnderpinningService.Message, null, UnderpinningServiceType.AAI, this._logCorrelationScope.CorrelationId);
		...
		private async Task EnsureRole(String groupId, String roleName)
		{
			...
			if(roles == null) throw new TerraUnderpinningException(this._errors.UnderpinningService.Code, this._errors.UnderpinningService.Message, null, UnderpinningServiceType.AAI, this._logCorrelationScope.CorrelationId);
		...
		private async Task AssignTargetGrantToUser(String subjectId, Guid targetId, String attributeValue, List<String> roles)
		{
			...
			if(group == null) throw new TerraUnderpinningException(this._errors.UnderpinningService.Code, this._errors.UnderpinningService.Message, null, UnderpinningServiceType.AAI, this._logCorrelationScope.CorrelationId);
